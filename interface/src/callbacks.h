...
void
on_btn_modifier_nassim_clicked         (GtkButton       *button,
                                        gpointer         user_data);
...
void
on_pourcentage_sexe_clicked            (GtkButton       *button,
                                        gpointer         user_data);
...
void
on_btn_ajout_nassim_clicked            (GtkButton       *button,
                                        gpointer         user_data);

void
on_btn_supprimer_nassim_clicked        (GtkButton       *button,
                                        gpointer         user_data);
